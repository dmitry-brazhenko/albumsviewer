...
Every file has a random 32-char hex name. Noise files (equal in count to real files, similar in size ±15%) make it impossible to infer how many media items the album contains or distinguish chunks from thumbnails.
